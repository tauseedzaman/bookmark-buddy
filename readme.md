...
[![GitHub Stars](https://img.shields.io/github/stars/tauseedzaman/bookmark-buddy)](https://github.com/tauseedzaman/bookmark-buddy)
...
* Filter by file type (`.zip`, `.exe`, `.dmg`, `.pdf`, etc.)
* Sort by date added, name, or usage
...
3. **Load the extension**
   ...
   * Click **Load unpacked**
   * Select the `bookmark-buddy` directory
...
**💡 Tip**
Bookmark Buddy works best as a long-term personal archive of tools and resources you may need again.
